...
print "DEBUG_POINT4 = %d" % DEBUG_POINT3
...
def save_election_info(election_name, election_type, election_level, prv_name, sgg_name, emd_name, precinct_name, candidate_id, total_type, vote):
    if DEBUG_POINT4:
        ...
        print "count_type = %s" % total_type.encode("utf8")
        print "vote = %d" % vote
...
for file_in_dir in files_in_dir:
    ...
    if m:
        ...
        election_type = info_from_filename[0][2:]  # 1_시도지사선거 이런 식으로 되어 있음.
        ...
        for sheet in wb.sheets():
            ...
            if election_level == 1:
                ...
                # sgg_name은 두 번줄 헤더에서 스플릿해서 찾아야한다.
            ...
            for rownum in xrange(sh.nrows):
                ...
                if header_index == 1:
                ...
                elif header_index == 3: # this is the header with candidate information
                    # this is the header, and should be processed to add 의원 info
                    if values[0] == "" and not candidate_added: # 후보자를 중복해서 추가하지 말자.
                    ...
                    if column_offset >= 0: # 광역레벨인 경우에는 첫 컬럼이 시군구 선관위명이다.
                        ...
                        "otherwise, you have already sgg_name from header"
