...
elec = election_info.get( election_info.elec_date == '2012-04-11' )
...
for elec_area in elec_area_info.select().join( elec_elec_area_relation ).join( election_info ).where( election_info.elec_date == '2012-04-11' ):
...
f = codecs.open("webapp_data/20120411_election.geojson", encoding='utf-8', mode='w')
f.write ( geoJSON )
f.close()
