...
election_data_json = "var election_data = " + json.dumps( election_data, separators = (',', ':'), indent=4, sort_keys = True ) + ";"

f = codecs.open("webapp_data/20120411_election_data.json", encoding='utf-8', mode='w')
