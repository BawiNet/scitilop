...
properties_template = string.Template( '{"sig_nm": "$sig_nm","sig_cd": "$sig_cd", "sig_lvl1" : "$sig_lvl1"  }' )
features = []

for area in area_info.select().where( area_info.sig_lvl == 2):
    feature = {}
    ...
    feature['properties'] = { "sig_nm": area.sig_nm, "sig_cd": area.sig_cd, "sig_lvl1": lvl1_name }
...
features.append( {  "geometry": 
                        {"type": "MultiPolygon",
                         ...
                         "type": "Feature",
                         "properties": {"sig_nm": "dummy1","sig_cd": "9999999", "sig_lvl1": "dummy1" }
                 } 
                )
features.append( {  "geometry": 
                       {"type": "MultiPolygon","coordinates": [[[[34.702075,36.219219],[34.937832,36.086951],[34.611321,35.885996],[34.292952,36.04197],[34.702075,36.219219]]],[[[34.968326,35.898573],[35.197403,36.021408],[35.216241,35.843566],[35.067838,35.80399],[34.968326,35.898573]]]]},
                        "type": "Feature",
                        "properties": {"sig_nm": "dummy2","sig_cd": "9999998", "sig_lvl1":"dummy2" }
                } 
              )
...
f = codecs.open("2014_SGG.geojson", encoding='utf-8', mode='w')
f.write ( geoJSON )
f.close()
